   ...
   // }
    ...
    return (
        <div className="eventcontainer">
            <form className="d-flex" role="search" style={{ position: "absolute", bottom: "101%" , left: "50%", }} >
            ...
            <div className="row">
                <div>
                <div className="form-floating" style={{ borderRadius: "20%" }} onChange={(e) => statuschange(e)}></div>
                </div>
                            ...
                            <div className="card">
                               {/* {tasks.status === "inprogress" && <button style={{ position: "absolute", }} className="btn btn-success" onClick={(e) => starttask(e, tasks._id, tasks.status)}>{'completed'}</button>}
                                ...
                                <div className="card-body">
                                    <h5 className="card-title"style={{color:"red"}}> Name: {tasks.eventName}</h5>
                                    <p className="card-text">Location:{tasks.eventlocation}</p>
                                    <p className="card-text">Timings:{tasks.eventtiming}</p>
                                    <p className="card-text">Amount:{tasks.eventamount}</p>

                                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                                        {/*<span className="btn btn-success">BOOK NOW</span>*/}
                                        <span className="btn btn-danger" onClick={(e) => deletetask(e, tasks._id)} style={{textAlign:"center",marginLeft:"30%"}}>delete</span>
                                    </div>
                                </div>
                            </div>
                        </div>
